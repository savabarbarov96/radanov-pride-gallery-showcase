...
const ModernHeroSection = () => {
  ...
  return (
    <section className="min-h-[85vh] flex items-center justify-center py-10 md:py-20 bg-[#F5F4F0] relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-16 items-center">
          ...
          >
            <div className="space-y-4 md:space-y-6">
              <div className="font-playfair text-3xl md:text-5xl lg:text-6xl xl:text-7xl font-light text-black leading-tight">
                <div className="animate-fade-in-left">
                  <ContainerTextFlipDemo />
                </div>
                <span className="block border-l-4 border-black pl-4 md:pl-6 ml-0 font-normal mt-3 md:mt-4 animate-fade-in-left animate-delay-200">
                  Мейн Куун
                </span>
                <span className="block text-2xl md:text-4xl lg:text-5xl xl:text-6xl mt-3 md:mt-4 font-light text-gray-600 animate-fade-in-left animate-delay-300">
                  котки
                </span>
              </div>
            </div>
            ...
            <div className="flex justify-center lg:justify-start">
              <Button 
                className="px-6 md:px-8 py-3 md:py-4 text-sm md:text-base font-medium bg-black text-white hover:bg-gray-800 transition-colors animate-fade-in-up animate-delay-400"
              >
            ...
            >
              ...
              <div className="hidden md:block absolute -top-10 -left-24 bg-white p-4 shadow-lg transform rotate-6 hover:rotate-0 transition-transform duration-300 animate-float-gentle z-10">
                ...
                <div className="mt-2 text-center">
                  <h3 className="font-bold text-base text-black">BUBBLE</h3>
                  <p className="text-xs text-gray-600 uppercase tracking-wide">SILLY CAT</p>
                </div>
              </div>
              <div className="hidden lg:block absolute top-32 -right-32 bg-white p-4 shadow-lg transform -rotate-12 hover:rotate-0 transition-transform duration-300 animate-float-reverse z-10">
                ...
                />
                <div className="mt-2 text-center">
                  <h3 className="font-bold text-base text-black">ZIGGY</h3>
                  <p className="text-xs text-gray-600 uppercase tracking-wide">SILLY CAT</p>
                </div>
              </div>
              <div className="hidden md:block absolute bottom-0 left-1/2 -translate-x-1/2 bg-white p-4 shadow-lg transform rotate-3 hover:rotate-0 transition-transform duration-300 animate-float-gentle z-10">
                ...
                />
                <div className="mt-2 text-center">
                  <h3 className="font-bold text-base text-black">MOMO</h3>
                  <p className="text-xs text-gray-600 uppercase tracking-wide">SILLY CAT</p>
                </div>
              </div>
              ...
              <div className="relative bg-white p-3 md:p-4 shadow-lg transform hover:rotate-0 transition-transform duration-300 animate-scale-in animate-delay-300 animate-float-gentle z-20">
                ...
                <div className="mt-3 md:mt-4 text-center">
                  <h3 className="font-bold text-base md:text-lg text-black">OLIVIA</h3>
                  <p className="text-xs md:text-sm text-gray-600 uppercase tracking-wide">CHAT NOIR ELEGANCE</p>
                </div>
              </div>
              <div className="absolute top-6 md:top-8 left-16 md:left-20 bg-white p-3 md:p-4 shadow-lg transform hover:rotate-0 transition-transform duration-300 animate-scale-in animate-delay-500 animate-float-reverse z-20">
                ...
                />
                <div className="mt-3 md:mt-4 text-center">
                  <h3 className="font-bold text-base md:text-lg text-black">MIA</h3>
                  <p className="text-xs md:text-sm text-gray-600 uppercase tracking-wide">NOIR</p>
                </div>
              </div>
