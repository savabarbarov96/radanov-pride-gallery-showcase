const Footer = () => {
  return (
    <footer className="bg-luxury-dark-brown text-white py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#cats" className="text-white/80 hover:text-luxury-gold transition-colors">
                  Наши котки
                </a>
              </li>
              <li>
                <a href="#gallery" className="text-white/80 hover:text-luxury-gold transition-colors">
                  Галерия
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-white/20 mt-8 pt-8 text-center">
          <p className="text-white/60">
            © 2024 Maine Coon Radanov Pride. Всички права запазени.
          </p>
        </div>
      </div>
    </footer>
